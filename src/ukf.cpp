...
UKF::UKF() {
  ...
  */
  ...
  n_x_ = 5;
  n_aug_ = 7; // add in the process noise for angle and angle rate

  lambda_ = 3 - n_aug_; // taken from tutorials as the recommended value to use here.   
...
void UKF::ProcessMeasurement(MeasurementPackage meas_package) {
  ...
  */
	...
	double time_delta = Tools::MicroSecsToSecs(meas_package.timestamp_ - time_us_);	// convert us to seconds
	time_us_ = meas_package.timestamp_;
